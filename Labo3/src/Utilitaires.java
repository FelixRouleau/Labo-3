...
public class Utilitaires {
    ...
    public static ArrayList<ArrayList<String>> chargerFichierTexte(String fichier, String delimiteurs)
            throws Exception {
        String ligne;
        ...
        try {
            ...
            while (ligne != null) {// Si ligne == null alors ont a atteint la fin du fichier
                ...
                listeAttributs.add(attributs);// elems[0] contient le num�ro du livre;elems[1] le titre et elems[2] les
                                              // pages
                // biblio.add(new Object(Integer.parseInt(elems[0]), elems[1],
